...
export class GroupsPage {
  ...
  ionViewDidLoad() {
    ...
    // Get groups
    this.dataProvider.getGroups().take(1).subscribe((groupList) => {
  ...
  showGroupTimeline(groupId, groupName) {

    this.navCtrl.push(TimelinePage, { groupId: groupId, groupName: groupName });
  }
